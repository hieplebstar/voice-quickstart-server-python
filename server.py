...
PUSH_CREDENTIAL_SID_IOS = 'CRd70b8b94c28a79ce35856b84733c1920'
##'CRe020cdf08fdc820e59a708458cda311e'

##CR46ae38c939adf11bee2ecdc8e9e4a0b1'

PUSH_CREDENTIAL_SID_ANDROID = 'CR015aced12a7c5a320116236b2191f4e8'
##'CR0776cf10fe89986c7d40628e532dcd31'
...
def callLog():
    ...
    result = []
    for call in client.calls.list(to=userCallerNumber, started_after=booking_start):
        if call.direction != 'inbound':
            ...
            result.append(tmp)
    for call in client.calls.list(from_=userCallerNumber,started_after=booking_start):
        if call.direction != 'inbound':
            tmp = {
                'type': 'Outbox',
